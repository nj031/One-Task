    ...
    Scaffold(containerColor = MaterialTheme.colorScheme.background) { innerPadding ->
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text(
                    text = stringResource(id = R.string.week_starts_on_title),
            ...
            Text(
                text = stringResource(id = R.string.week_starts_on_description),
...
@Composable
private fun SettingOptionRow(label: String, selected: Boolean, onClick: () -> Unit) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
